  ...
  <div class="min-h-screen bg-[var(--color-bg-base)] flex flex-col font-body">
    ...
    <header class="bg-[var(--color-bg-raised)] border-b border-[var(--color-border-subtle)] px-8 py-4 flex justify-between items-center sticky top-0 z-40 shadow-sm">
      <div class="flex items-center space-x-4">
        ...
        <h1 class="text-2xl font-display text-[var(--color-text-primary)] tracking-tight">Python Tutor</h1>
      </div>
    ...
    <main class="flex-1 flex overflow-hidden">
      <!-- Sidebar: Assignments -->
      <aside class="w-80 bg-[var(--color-bg-raised)] border-r border-[var(--color-border-subtle)] flex flex-col p-6 shadow-sm overflow-y-auto">
      ...
      <div class="flex-1 flex flex-col relative bg-[var(--color-bg-base)]/50">
        <div class="flex-1 flex flex-col lg:flex-row overflow-hidden p-8 gap-8">
          <!-- Editor Area -->
          <div class="flex-[3] flex flex-col bg-white rounded-3xl shadow-sm border border-[var(--color-border-subtle)] overflow-hidden group hover:shadow-md transition-shadow">
            <div class="px-6 py-4 border-b border-[var(--color-border-subtle)] flex justify-between items-center bg-[var(--color-bg-raised)]">
              ...
              <div class="flex items-center space-x-3">
                <span v-if="isSubmitting" class="text-xs font-heading font-bold text-[var(--color-accent-orange)] animate-pulse flex items-center">
          ...
          <div class="flex-[2] flex flex-col bg-white rounded-3xl shadow-sm border border-[var(--color-border-subtle)] overflow-hidden hover:shadow-md transition-shadow">
