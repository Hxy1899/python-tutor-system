        ...
        selectorList.each((sel)=>{
            ...
            utilitySelectorsList.each((utilitySelector)=>{
                ...
                utilitySelector.walkClasses((node)=>{
                    ...
                    // For example with `.foo + .foo { ÔÇª }` and `section { @apply foo; }`
    ...
    for (let [parent, [candidates, atApplySource]] of perParentApplies){
        ...
        for (let [applyCandidate, important, rules] of candidates){
            ...
            for (let [meta, node] of rules){
                ...
                // When we encounter a rule like `.dark .a, .b { ÔÇª }` we only want to be left with `[.dark, .a]` if the base applyCandidate is `.a` or with `[.b]` if the base applyCandidate is `.b`
