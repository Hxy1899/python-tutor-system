 ...
 * Technically :is(), :not(), :has(), etcΓÇª can have combinators but those are nested
...
function finalizeSelector(current, formats, { context , candidate , base  }) {
    ...
    //           Γö¼  Γö¼     Γö¼            Γö¼
    //           Γöé  Γöé     Γöé            Γò░ΓöÇΓöÇ We will not split here
    //           Γò░ΓöÇΓöÇΓö┤ΓöÇΓöÇΓöÇΓöÇΓöÇΓö┤ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ We will split here
    //
