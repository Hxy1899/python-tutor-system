 ...
 * Technically :is(), :not(), :has(), etcÔÇª can have combinators but those are nested
...
export function finalizeSelector(current, formats, { context, candidate, base }) {
  ...
  //           Ôö¼  Ôö¼     Ôö¼            Ôö¼
  //           Ôöé  Ôöé     Ôöé            Ôò░ÔöÇÔöÇ We will not split here
  //           Ôò░ÔöÇÔöÇÔö┤ÔöÇÔöÇÔöÇÔöÇÔöÇÔö┤ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ We will split here
  //
