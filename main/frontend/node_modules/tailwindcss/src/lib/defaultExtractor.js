    ...
    regex.pattern([
      ...
      regex.optional(
        regex.any([
          ...
          // Normal values w/o quotes ÔÇö may include an opacity modifier
          /[-\/][^\s'"`\\$={><]*/,
        ])
      ),
    ]),
...
/**
 * Clips a string ensuring that parentheses, quotes, etcÔÇª are balanced
 ...
 *   Ôö¼    Ôö¼          Ôö¼Ôö¼       Ôö¼        Ôö¼Ôö¼   Ôö¼Ôö¼Ôö¼Ôö¼Ôö¼Ôö¼Ôö¼
 *   1    2          3        4        34   3 210 END
 *   Ôò░ÔöÇÔöÇÔöÇÔöÇÔö┤ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔö┤ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔö┤ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔö┤Ôö┤ÔöÇÔöÇÔöÇÔö┤ÔöÇÔö┤Ôö┤Ôö┤
 *
 * @param {string} input
 */
