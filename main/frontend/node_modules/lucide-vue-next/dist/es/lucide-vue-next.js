...
const createLucideIcon = (iconName, iconNode) => ({ size, color, ...props }, { attrs, slots }) => {
  return h(
    "svg",
    {
      ...defaultAttributes,
