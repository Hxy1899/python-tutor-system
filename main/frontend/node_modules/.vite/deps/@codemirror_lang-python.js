import { S as Transaction, b as StateField, d as MapMode, f as Prec, g as RangeValue, l as Facet, s as EditorSelection, t as Annotation, v as StateEffect, x as Text } from "./dist-B2ze1ZqJ.js";
import { P as keymap, a as Decoration, p as WidgetType, s as EditorView } from "./dist-BBuUoFDH.js";
import { C as NodeWeakMap, S as NodeType, T as Tree, _ as tags, a as delimitedIndent, b as NodeProp, f as indentUnit, g as styleTags, h as syntaxTree, i as LanguageSupport, o as foldInside, r as LRLanguage, s as foldNodeProp, u as indentNodeProp, v as DefaultBufferLength, w as Parser, x as NodeSet, y as IterMode } from "./dist-DtUsn3la.js";
...
var InputStream = class {
	...
	*/
	...
	effectiveness incremental parsingÔÇöwhen looking forwardÔÇöor even
...
var baseTheme = /* @__PURE__ */ EditorView.baseTheme({
	...
	".cm-completionIcon-function, .cm-completionIcon-method": { "&:after": { content: "'ãÆ'" } },
	".cm-completionIcon-class": { "&:after": { content: "'Ôùï'" } },
	".cm-completionIcon-interface": { "&:after": { content: "'Ôùî'" } },
	".cm-completionIcon-variable": { "&:after": { content: "'­ØæÑ'" } },
	".cm-completionIcon-constant": { "&:after": { content: "'­ØÉÂ'" } },
	".cm-completionIcon-type": { "&:after": { content: "'­Øæí'" } },
	".cm-completionIcon-enum": { "&:after": { content: "'Ôê¬'" } },
	".cm-completionIcon-property": { "&:after": { content: "'Ôûí'" } },
	".cm-completionIcon-keyword": { "&:after": { content: "'­ƒöæ´©Ä'" } },
	".cm-completionIcon-namespace": { "&:after": { content: "'Ôûó'" } },
