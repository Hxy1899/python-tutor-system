 ...
 * `new `**`StyleModule`**`(spec:Â Object< Style >, options:Â ?{finish:Â ?fn(string) â†’Â string})`\
 ...
 * `static `**`newName`**`() â†’Â string`\
   Generate a new unique CSS class name.

 * `static `**`mount`**`(root:Â Document | ShadowRoot, modules:Â [StyleModule] | StyleModule, options:Â ?{nonce:Â ?string})`\
