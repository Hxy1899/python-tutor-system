...
// in turn calls the function that parses `[]` subscripts ├ö├ç├Â that
...
// Parse an atomic expression ├ö├ç├Â either a single token that is an
...
// be a `[]` or dot subscript expression, but not a call ├ö├ç├Â at least,
