...
Fraction.prototype = {
  ...
  "mod": function (a, b) {
     ...
     *
     *    n1/d1 = (n2/d2) * q + r, where 0 ÎÃ«Ã± r < n2/d2
  ...
  "pow": function (a, b) {
    ...
    //     (-a/b)^(c/d) = x
    // ÎÃ§Ã¶ (-1)^(c/d) * (a/b)^(c/d) = x
    // ÎÃ§Ã¶ (cos(pi) + i*sin(pi))^(c/d) * (a/b)^(c/d) = x
    // ÎÃ§Ã¶ (cos(c*pi/d) + i*sin(c*pi/d)) * (a/b)^(c/d) = x       # DeMoivre's formula
  ...
  "roundTo": function (a, b) {
    ...
    /*
    k * x/y ÎÃ«Ã± a/b < (k+1) * x/y
    ÎÃ§Ã¶ k ÎÃ«Ã± a/b / (x/y) < (k+1)
    ÎÃ§Ã¶ k = floor(a/b * y/x)
    ÎÃ§Ã¶ k = floor((a * y) / (b * x))
    */
  ...
  "simplify": function (eps = 1e-3) {
    ...
    // generally outperforming mediants in denominatorÎÃÃŽaccuracy trade-offs.
