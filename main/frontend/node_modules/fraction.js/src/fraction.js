...
Fraction.prototype = {
  ...
  "mod": function (a, b) {
     ...
     *
     *    n1/d1 = (n2/d2) * q + r, where 0 Γëñ r < n2/d2
  ...
  "pow": function (a, b) {
    ...
    //     (-a/b)^(c/d) = x
    // Γçö (-1)^(c/d) * (a/b)^(c/d) = x
    // Γçö (cos(pi) + i*sin(pi))^(c/d) * (a/b)^(c/d) = x
    // Γçö (cos(c*pi/d) + i*sin(c*pi/d)) * (a/b)^(c/d) = x       # DeMoivre's formula
  ...
  "roundTo": function (a, b) {
    ...
    /*
    k * x/y Γëñ a/b < (k+1) * x/y
    Γçö k Γëñ a/b / (x/y) < (k+1)
    Γçö k = floor(a/b * y/x)
    Γçö k = floor((a * y) / (b * x))
    */
  ...
  "simplify": function (eps = 1e-3) {
    ...
    // generally outperforming mediants in denominatorΓÇôaccuracy trade-offs.
