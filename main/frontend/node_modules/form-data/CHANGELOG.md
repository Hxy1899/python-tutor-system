...
- [meta] actually ensure the readme backup isnтАЩt published [`316c82b`](https://github.com/form-data/form-data/commit/316c82ba93fd4985af757b771b9a1f26d3b709ef)
...
- [Fix] set┬а`Symbol.toStringTag` when┬аavailable [`#573`](https://github.com/form-data/form-data/pull/573)
- [Fix] set┬а`Symbol.toStringTag` when┬аavailable [`#573`](https://github.com/form-data/form-data/pull/573)
...
- [Fix] set┬а`Symbol.toStringTag` when┬аavailable (#573) [`#396`](https://github.com/form-data/form-data/issues/396)
- [Fix] set┬а`Symbol.toStringTag` when┬аavailable (#573) [`#396`](https://github.com/form-data/form-data/issues/396)
- [Fix] set┬а`Symbol.toStringTag` when┬аavailable [`#396`](https://github.com/form-data/form-data/issues/396)
...
- [meta] actually ensure the readme backup isnтАЩt published [`0150851`](https://github.com/form-data/form-data/commit/01508513ffb26fd662ae7027834b325af8efb9ea)
...
- [meta] actually ensure the readme backup isnтАЩt published [`10626c0`](https://github.com/form-data/form-data/commit/10626c0a9b78c7d3fcaa51772265015ee0afc25c)
